...
@RequestMapping("file")
    ...
    */
    ...
    @ResponseBody
    @RequestMapping("/get")
    public ResultBody<File> get(@RequestParam("id") Long id){
    ...
    */
    ...
    @ApiImplicitParams({
         ...
         @ApiImplicitParam(name = "fileName", required = true, value = "文件名称", paramType = "form"),
         @ApiImplicitParam(name = "fileType", required = true, value = "文件类型", paramType = "form"),
         @ApiImplicitParam(name = "fileSize", required = true, value = "文件大小(KB)", paramType = "form"),
